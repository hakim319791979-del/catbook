        ...
        children: [
          Card(
            child: Padding(
              ...
              child: Column(
                children: [
                  TextField(controller: _catName, decoration: const InputDecoration(labelText: 'Cat name'), onChanged: (_) => setState(() {})),
                  const SizedBox(height: 12),
                  TextField(controller: _catId, decoration: const InputDecoration(labelText: 'Cat ID'), onChanged: (_) => setState(() {})),
                ],
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text('Scan the QR to read payload', style: TextStyle(color: cs.onSurfaceVariant)),
                ],
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: FilledButton.icon(onPressed: _saveLocal, icon: const Icon(Icons.save_alt), label: const Text('Save'))),
                      const SizedBox(width: 12),
                      Expanded(child: OutlinedButton.icon(onPressed: _loadLocal, icon: const Icon(Icons.download), label: const Text('Load'))),
                    ],
                  ),
                  const SizedBox(height: 8),
